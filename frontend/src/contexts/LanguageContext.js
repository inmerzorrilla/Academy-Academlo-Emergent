...
const translations = {
  ...
  es: {
    ...
    // Project Module Messages
    createProjectEmergent: 'Crea tu Proyecto con Emergent',
    timeToCreateSomethingIncredible: '¡Es hora de crear algo increíble!',
    yourMission: 'Tu misión',
    useEmergentToCreateProject: 'Utiliza la plataforma',
    toDemonstrateWhatYouLearned: 'para crear un proyecto que demuestre todo lo que has aprendido en ACADEMY',
    projectIdeas: 'Ideas de proyectos',
    projectIdea1: 'Un chatbot inteligente con IA',
    projectIdea2: 'Una aplicación web con funcionalidades avanzadas',
    projectIdea3: 'Un sistema de automatización inteligente',
    projectIdea4: 'Una herramienta que resuelva un problema real',
    requirements: 'Requisitos',
    requirement1: 'Debe ser creado en la plataforma Emergent',
    requirement2: 'Debe aplicar conceptos aprendidos en el curso',
    requirement3: 'Debe ser funcional y demostrable',
    goToEmergentToCreateProject: 'Ir a Emergent para crear tu proyecto',
    onceProjectCreatedComeBack: 'Una vez que hayas creado tu proyecto, regresa aquí para enviar la URL',
    submitYourProject: 'Enviar tu Proyecto',
    projectSubmittedSuccessfullyTitle: '¡Proyecto Enviado Exitosamente!',
    projectHasBeenRegistered: 'Tu proyecto ha sido registrado correctamente',
    projectUrlLabel: 'URL de tu proyecto en Emergent',
    projectUrlPlaceholder: 'https://tu-proyecto.emergent.sh/',
    validEmergentUrlRequired: 'Debe ser una URL válida de un proyecto creado en Emergent',
    submitting: 'Enviando',
